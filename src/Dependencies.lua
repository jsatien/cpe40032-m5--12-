...
gSounds = {
    ...
    ['music'] = love.audio.newSource('sounds/Prologue (2).mp3'),
...
gTextures = {
    ...
    ['backgrounds'] = love.graphics.newImage('graphics/background2.png'),
    ['green-alien'] = love.graphics.newImage('graphics/hp1.png'),
